 ...
 * /recipes/{recipeId}/steps:
 *   get:
 *     summary: Endpoint for retrieving a recipe's steps
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Recipe steps retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 * /recipes/{recipeId}/ingredients:
 *   get:
 *     summary: Endpoint for retrieving a recipe's ingredients
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *     responses:
 *       200:
 *         description: Recipe ingredients retrieved successfully
 *         content:
 *           application/json:
 *             schema:
 *               type: array
 ...
 * /recipes/{recipeId}/ingredients/{ingredientId}:
 *   delete:
 *     summary: Endpoint for deleting an ingredient in a recipe
 *     security:
 *       - bearerAuth: []
 *     parameters:
 *       - in: path
 ...
 *                   type: string
 *       403:
 *         description: Authenticated user is not the recipe creator (Not allowed to delete ingredients)
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *                   type: string
 *       404:
 *         description: Recipe with specified ID is not found / Ingredient is not found in specified recipe
 *         content:
 *           application/json:
 *             schema:
 *               type: object
